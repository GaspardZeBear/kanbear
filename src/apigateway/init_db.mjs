import {db } from './config/database.mjs'
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS tasks (
      ...
      FOREIGN KEY(swimlane_id) REFERENCES swimlanes(id) ON DELETE SET DEFAULT,
      FOREIGN KEY(column_id) REFERENCES columns(id) ON DELETE SET DEFAULT
    )
  `);
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS task_has_tags (
      ...
      FOREIGN KEY(task_id) REFERENCES tasks(id) ON DELETE SET DEFAULT,
      FOREIGN KEY(tag_id) REFERENCES tags(id) ON DELETE SET DEFAULT
    )
  `);
