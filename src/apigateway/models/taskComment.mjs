...
class TaskComment {
  ...
  static getAll(callback) {
    Konsol.log("TaskComment.getAll()","callback",callback)
  ...
  static getById(id, callback) {
    Konsol.log("TaskComment.getById()","callback",callback)
  ...
  static getByTaskId(taskId, callback) {
    Konsol.log("TaskComment.getByTaskId()","callback",callback)
  ...
  static delete(id, callback) {
    Konsol.log("TaskComment.delete()","callback",callback)
